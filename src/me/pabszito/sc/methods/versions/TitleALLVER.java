...
import org.simplessentials.api.events.PlayerTitleEvent;
import org.bukkit.Bukkit;
import org.bukkit.entity.Player;

public class TitleALLVER
{
    ...
    public static void sendTitle(final Player player, final Integer fadeIn, final Integer stay, final Integer fadeOut, String title, String subtitle) {
        final PlayerTitleEvent titleSendEvent = new PlayerTitleEvent(player, title, subtitle);
